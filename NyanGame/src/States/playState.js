...
PlayState.create = function () {
    ...
    this.nyan = new Nyan(this, 100, 100, this.control.hands[0].roll);
...
PlayState.update = function () {
    ...
    if(this.control.controllerConnected){
        this.nyan.updatePos(this.control.hands[0].posX, this.control.hands[0].posY, this.control.hands[0].roll);
        this.updateText();
        this.nyan.x = this.control.hands[0].posX + 280;
        this.nyan.y = -this.control.hands[0].posY + 285;
        this.checkCollsions();
        
        this.nyan.spawnBoxes(
...
PlayState.checkCollsions = function(){
    ...
    for (var j = 0; j < pillars.length; j++){ //collides with enemy
            if(this.nyan.physics.overlaps(pillars[j])){
